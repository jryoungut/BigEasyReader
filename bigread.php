...
<head>
    ...
    <script type="text/javascript">
		...
		$(document).on('pageinit', '#pgBigRead', function(){ 
			...
			$('.spritzer-header').show();
			if(SpritzClient.isUserLoggedIn()===false){
				$(".spritzer-login-btn").trigger('click');
			}
        ...
        function initSpritz(ctrl, customOps) {
          var contentUrl = 'http://www.zaycounlimited.com/ezbigread/<?php echo $location; ?>';//Books/PoetryOfASoldier.txt';
		  ...
		  spritzer.on("onSpritzBack", function(event, position, pausePos) {console.log("onSpritzBack: " + position + "/" + pausePos);});
		  spritzer.on("onSpritzForward", function(event, position, pausePos) {console.log("onSpritzForward: " + position + "/" + pausePos);});
...
<body>
    <div data-role="page" id="pgBigRead">
        <div data-role="header">
        	<a id="btnHome" href="Books.php" data-role="button"  data-mini="true" data-ajax="true">Back</a>
        ...
        <div data-role="content">
            ...
            <div class="hide">
            	word <span id="wordNumber">0</span> of <span id="wordTotal">?</span>
            </div>
            <div class="spacer-b">
