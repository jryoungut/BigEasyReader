...
<head>
    ...
    <title>Speed Settings - Big EZ Reader</title>
	...
	<script type="text/javascript">
		...
		$(document).on('pageinit', '#pgSpeed', function(){   
		    ...
		    $('#speedCtrl').on('slidestop', function(event, ui){
				...
				CustomOptions.defaultSpeed = Speed;
        ...
        function centerSpritzerControl(ctrl, h, w){
        	...
        	var winHeight = $('#pgSpeed').height() - $('#speedCtrl').position().top - $('#speedCtrl').height() - 30;
...
<!-- page -->
    <div data-role="page" id="pgSpeed">
        ...
        <div data-role="content">
        	<div id="speedHolder">
        		<input type="range" name="speedCtrl" id="speedCtrl" data-highlight="true" min="1" max="1000" step="1" value="170">
        	</div>
        	<div class="clear"></div>
